...
namespace UI.Desktop
{
    public partial class Usuario : Form
    {
        ...
        private void Pesquisar(string nome)
        {
            ...
            dataGridView1.DataSource = _RepositoryControlUsuario.PesquisarUsuario("").Select(a => new
            {
                ID = a.CodigoUsuario
                ,
                Nome = a.Nome
        ...
        private void CompletarCampos(Usuarios usuarios)
        {
            ...
            comboTipo.SelectedItem = usuarios.Cliente == null ? "Cliente" : "Funcionario";
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            {
                toolStripStatusLabel1.Text = "Sexo" + ": " + "Selecione um sexo";
            }
